...
(function () {
  ...
  let _previewTimers = [];
  function clearPreview() { _previewTimers.forEach(id => { clearTimeout(id); clearInterval(id); }); _previewTimers = []; }

  function render() { clearPreview(); STEPS[step](); }
  ...
  function session() {
    ...
    frame([
      ...
      UI.el('div', { style: { marginTop: '20px', textAlign: 'center' } }, [
